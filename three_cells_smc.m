...
load('gse19830');
three_cells_data = double(gse19830_data);  
pu1 = three_cells_data(:,1:3); sum_pu1 = sum(pu1'); avg_pu1 = sum_pu1'/3;
pu2 = three_cells_data(:,4:6); sum_pu2 = sum(pu2'); avg_pu2 = sum_pu2'/3;
pu3 = three_cells_data(:,7:9); sum_pu3 = sum(pu3'); avg_pu3 = sum_pu3'/3; 
cell_spec_expr_value = [avg_pu1 avg_pu2 avg_pu3]; 

% Extract mixed samples.
YY = three_cells_data(:,10:42);

% Known cell type proportions.
cell_prop = [0.05 0.05 0.05 0.70 0.70 0.70 0.25 0.25 0.25 0.70 0.70 0.70 0.45 0.45 0.45 0.55 0.55 0.55 0.50 0.50 0.50 0.55 0.55 0.55 0.50 0.50 0.50 0.60 0.60 0.60 0.65 0.65 0.65;...
             0.25 0.25 0.25 0.05 0.05 0.05 0.70 0.70 0.70 0.25 0.25 0.25 0.45 0.45 0.45 0.20 0.20 0.20 0.30 0.30 0.30 0.30 0.30 0.30 0.40 0.40 0.40 0.35 0.35 0.35 0.34 0.34 0.34;...
...
% Prior specification for the error precision
 alpha_prior = 2;
 beta_prior = 100000; %100000

% 3. X

% Prior specification for the cell specific expression levels.
